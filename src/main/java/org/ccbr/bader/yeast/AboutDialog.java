...
public class AboutDialog extends JDialog {
	...
	private static final String URL = "http://baderlab.org/Software/ThematicMap";
	...
	@Inject
	public AboutDialog(CySwingApplication application) {
		super(application.getJFrame(), "About Thematic Map", ModalityType.MODELESS);
		setResizable(false);
		...
		editorPane
				.setText("<html><body>"
						...
						+ "<td width='125'></td>"
						+ "<td width='200'>"
						+ "<p align=center><b>Thematic Map</b><BR>A Cytoscape App<BR><BR></p>"
						+ "<p align=center>Version: " + version + "<br>Build: " + timestamp + "</p>"
						+ "</td>"
						+ "<td width='125'><div align='right'></td>"
						+ "</tr></table>"
						+ "<p align=center>"
						+ "Creates a network where each selected attribute value<BR>"
						+ "from the input network is used as a 'theme' and the<BR>"
						+ "connections between the themes are visualized."
						+ "<BR><BR>"
						+ "by Mike Matan, Ruth Isserlin, Mike Kucera and Gary Bader<BR>"
