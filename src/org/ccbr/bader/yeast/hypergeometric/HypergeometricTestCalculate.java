package org.ccbr.bader.yeast.hypergeometric;
...
public class HypergeometricTestCalculate implements CalculateTestTask {
    ...
    public HypergeometricTestCalculate(Map smallN,Map smallX,int bigN, int bigX) {
    	this.mapSmallN = smallN;
    	this.mapSmallX = smallX;
    	this.bigN = bigN;
    	this.bigX = bigX;
    	this.maxValue = smallX.size();
    }
